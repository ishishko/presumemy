...
@media (prefers-color-scheme: dark) {
  .login-wrap {
    background: radial-gradient(circle at 10% 20%, rgba(170, 59, 255, 0.08) 0%, transparent 45%),
                radial-gradient(circle at 90% 80%, rgba(117, 204, 206, 0.1) 0%, transparent 50%),
                var(--page-bg);
  }
  ...
  .bg-blob-2 {
    background: rgba(117, 204, 206, 0.12);
  }

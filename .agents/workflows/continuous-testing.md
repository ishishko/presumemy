# Workflow: Testing Continuo del MVP en Paralelo
Permite al desarrollador delegar la generación de pruebas de forma asíncrona asegurando el alcance exacto de la intervención.

## Steps
1. **Inicialización del Entorno Aislado:**
   - Inicializar el subagente utilizando el modelo `Gemini 3.5 Flash`.
   - Configurar el entorno en **New Worktree Mode** para aislar el proceso.
